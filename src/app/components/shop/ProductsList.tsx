...
import Product from "../../images/shop/Product.avif";
...
const ProductsCard: React.FC<{ product: ProductProps }> = ({ product }) => {
  return (
    <div className="flex flex-col">
      ...
      <button className="mt-4 bg-teal-600 text-white px-6 py-2 rounded-full text-sm hover:bg-teal-700 transition-colors">
        SELECT ITEM
      </button>
    </div>
  );
